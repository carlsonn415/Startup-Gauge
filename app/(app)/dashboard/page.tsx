      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border rounded-lg p-6">
          ...
          <div className="space-y-3">
            <a
              href="/projects/new/discovery"
              className="block w-full rounded-md bg-black px-4 py-2 text-white text-center hover:opacity-90"
            >
              Start New Project
            </a>
            <a
              href="/pricing"
              className="block w-full rounded-md border border-gray-300 px-4 py-2 text-center hover:bg-gray-50"
            >
              Upgrade Plan
            </a>
